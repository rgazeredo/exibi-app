# Análise: Exibi - Alternativa Simplificada ao AZSign
...
**Posicionamento:**
- **AZSign**: Solução completa e robusta para clientes experientes
...
4. **Escalabilidade** - Caminho natural de upgrade para AZSign quando crescer
...
**Total: 5 tabelas** (vs ~15+ no AZSign)
...
**Total: 3 endpoints** (vs 10+ no AZSign)
...
**Total: 6 telas principais** (vs 15+ no AZSign)
...
## Comparativo: Exibi vs AZSign

| Funcionalidade | Exibi | AZSign |
|----------------|-------|--------|
...
### Para o Negócio
1. **Captura mercado de entrada** - Clientes que não pagariam AZSign
2. **Funil de upgrade** - Crescem no Exibi, migram para AZSign
...
### Stack Sugerida
- **Backend:** Laravel (mesmo do AZSign, reusa conhecimento)
- **Frontend:** React + Inertia (mesmo do AZSign)
- **Database:** PostgreSQL ou MySQL
- **Storage:** S3/MinIO
- **App:** Android TV (fork simplificado do AZSign)

### Reutilização do AZSign
- Componentes UI base
- Sistema de upload
...
1. Capturar clientes que não podem/querem pagar pelo AZSign
...
**Mantra:** "Se o cliente precisa de mais, ele está pronto para o AZSign."
