...
/**
* @see \App\Http\Controllers\TenantRoleController::index
...
const TenantRoleController = { search, list, index, create, store, edit, update, destroy }

export default TenantRoleController